...
double precision ::  deltax, deltat, h_BC, der_BC,c0, gamma,hs,sup,L
...
double precision, dimension(:),allocatable:: h, mu, Q,pressure,growth_vel
double precision :: load, viscosity
double precision :: mean_conc,mass0,mass,fluxL, cumul_flux,crystal_vel,intforce,friction
